...
@param authMethod  an object containing the auth method. Can be of type VeridiumBiometricVector or NSDictionary for non-biometric methods.
@param completion  the callback contaning the error if any occurred.
*/
- (void)setAuthenticationMethods:(nonnull id)authMethod
